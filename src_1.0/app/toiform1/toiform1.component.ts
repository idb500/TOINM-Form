  ...
  onSubmit() {
    ...
    if(Image.files && Image.files[0]){
     ...
     if(Image_opt.files && Image_opt.files[0]){
      ...
      formData.append('winningId', '123432' );
      formData.append('listid','1232');
      ...
      formData.append('pincode', '123432' );
      formData.append('preferred_content', this.paperType1.join(','));
      formData.append('mobileNo', this.selectedNewspaper[0].Opinion);
      formData.append('file', this.ImageFile, this.ImageFile.name);
      try {formData.append('file1', this.ImageFile_optional, this.ImageFile_optional.name );}
